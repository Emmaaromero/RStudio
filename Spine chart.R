...
library("readr")
mobile_services_ranking <- read_csv('~/OneDrive/Documentos/Data Science/Mineria de datos/data science marketing files/MDS_Chapter_1/MDS_Chapter_1/mobile_services_ranking.csv')
View(mobile_services_ranking)
conjoint.data.frame <- read.csv("~/OneDrive/Documentos/Data Science/Mineria de datos/data science marketing files/MDS_Chapter_1/MDS_Chapter_1/mobile_services_ranking.csv")
